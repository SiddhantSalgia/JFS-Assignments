...
public class Streams4
{
    ...
    public static void main(String[] args)
    {
        ...
        Trader t3 = new Trader("Nat", "Bangalore");
        Trader t4 = new Trader("Chris", "Delhi");
        Trader t5 =  new Trader("Clint", "Chennai");

        Trader t6 = new Trader("Peter", "Pune");
        Trader t7 = new Trader("Happy", "Delhi");
        Trader t8 = new Trader("Nate", "Delhi");
        Trader t9 = new Trader("Matt", "Pune");
