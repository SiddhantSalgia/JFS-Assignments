...
public class Streams2
{
    ...
    {
        News news1 = new News(1, "Amrit", "Kumar", "comment");
        News news2 =new News(2, "Nisarg", "B", "budget");
        News news3 = new News(1, "Shyam", "S", "comment");
        News news4 = new News(3, "Siddhant", "Salgia", "budget");
        News news5 = new News(1, "Shashank", "S", "comment");
        News news6 = new News(3, "Jenny", "Lopez", "budget");
        News news7 = new News(1, "Romeo", "Montigue" ,"comment");
