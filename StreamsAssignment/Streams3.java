...
public class Streams3
{
    ...
    {
        Trader t1 = new Trader("Tony", "Bangalore");
        Trader t2 = new Trader("Steve", "Pune");
        Trader t3 = new Trader("Bruce", "Bangalore");
        Trader t4 = new Trader("Nat", "Delhi");
        Trader t5=  new Trader("Clint", "Chennai");
        Trader t6 = new Trader("Shawn", "Pune");
        Trader t7 = new Trader("Michele", "Delhi");
        Trader t8 = new Trader("Gamora ", "Delhi");
        Trader t9 = new Trader("Peter", "Pune");
